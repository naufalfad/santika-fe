  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto pb-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Button onClick={() => setIsUploadOpen(true)} className="flex items-center gap-1.5 text-xs bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-4 flex items-center gap-3.5 border-b-4 border-b-blue-600 border-x-slate-200 border-t-slate-200 shadow-sm">
          <div className="p-2.5 bg-blue-50 text-blue-600 rounded-xl border border-blue-100/50"><FolderOpen size={20} /></div>
          <div>
        ...
        <Card className="p-4 flex items-center gap-3.5 border-b-4 border-b-emerald-600 border-x-slate-200 border-t-slate-200 shadow-sm">
          <div className="p-2.5 bg-emerald-50 text-emerald-600 rounded-xl border border-emerald-100/50"><ShieldCheck size={20} /></div>
          <div>
        ...
        <Card className="p-4 flex items-center gap-3.5 border-b-4 border-b-amber-500 border-x-slate-200 border-t-slate-200 shadow-sm">
          <div className="p-2.5 bg-amber-50 text-amber-600 rounded-xl border border-amber-100/50"><Clock size={20} /></div>
          <div>
      ...
      {/* Toolbar */}
      <Card className="p-3.5 bg-slate-50 border border-slate-200 flex flex-col md:flex-row gap-4 items-center">
        <div className="flex items-center gap-2 bg-white px-3 py-1.5 border border-slate-200 rounded-lg w-full md:w-96">
