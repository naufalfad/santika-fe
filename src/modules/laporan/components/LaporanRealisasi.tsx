            ...
            <table className="w-full text-left border-collapse">
                    ...
                    {realisations.length > 0 ? (
                        realisations.map((item) => (
                            <tr key={item.id} className="hover:bg-slate-50/50 transition-colors">
                                <td className="p-3 font-semibold text-slate-700 border-r">
                                    {item.nama}
                                </td>
                                <td className="p-3 text-right text-slate-600 font-medium border-r">
                ...
                <tfoot>
                    <tr className="text-slate-800 font-medium text-sm border-t border-slate-200">
                        <td className="p-4 border-r border-slate-200 text-xs">
                            Total Pagu Anggaran Paroki
                        </td>
                        <td className="p-4 text-right border-r border-slate-200 text-slate-800 font-semibold">
                            {formatIDR(totalAnggaran)}
                        </td>
                        <td className="p-4 text-right border-r border-slate-200 text-rose-600 font-semibold">
